"""
Django settings for djangoproject_caninoslook project.
...
ROOT_URLCONF = 'djangoproject_caninoslook.urls'
...
WSGI_APPLICATION = 'djangoproject_caninoslook.wsgi.application'
